...
export const handler = async (event) => {
  ...
  if (method === "GET") return { statusCode:200, headers, body:JSON.stringify({service:"CureBot",version:"3.0",status:"active",hospitals:HOSPITALS.length,labs:LABS.length,doctors:DOCTORS.length}) };
