...
function handleConversation(parsed, context) {
  ...
  switch (intent) {
    ...
    case "select_number": return handleNumberSelection(entities.number);
...
function handleNumberSelection(num) {
  switch (num) {
    case 1: return startAppointmentFlow({});
    case 2: return startLabTestFlow({});
    case 3: return findDoctor({});
    case 4: return findHospital({});
    case 5: return findLab({});
    case 6: return emergency();
    default: return { reply: `Please select a number between 1-6:\n\n1️⃣ Book a Doctor Appointment\n2️⃣ Schedule a Lab Test\n3️⃣ Search for a Doctor\n4️⃣ Find a Hospital\n5️⃣ Locate a Diagnostic Lab\n6️⃣ View Emergency Contacts`, context: {} };
  }
}
